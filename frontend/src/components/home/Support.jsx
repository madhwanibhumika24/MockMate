...
function Support() {
  ...
  return (
    <div id="support" className="scroll-mt-20 border-t border-slate-200 bg-slate-50">
      <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
        <div className="mx-auto max-w-2xl text-center">
          <span className="text-sm font-semibold uppercase tracking-wide text-brand-600">Support</span>
          <h2 className="mt-2 text-3xl font-bold text-slate-900">Questions? We've got answers</h2>
