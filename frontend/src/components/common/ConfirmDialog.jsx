      ...
      <div className="card w-full max-w-sm">
        ...
        <div className="mt-5 flex justify-end gap-2">
          ...
          <button
            type="button"
            onClick={onConfirm}
            className="relative overflow-hidden rounded-lg border border-red-300/50 bg-red-400/15 px-4 py-2 text-sm font-semibold text-red-600 shadow-sm shadow-red-900/5 backdrop-blur-md transition hover:bg-red-400/25"
          >
